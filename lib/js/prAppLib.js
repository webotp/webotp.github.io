(function () {
    ...
    const canPhonepeMakePaymentCache = 'canPhonepeMakePaymentCache',canGpayMakePaymentCache = 'canGpayMakePaymentCache';
    const phonepeHasEnrolledInstrumentCache = 'phonepeHasEnrolledInstrumentCache',gpayHasEnrolledInstrumentCache = 'gpayHasEnrolledInstrumentCache';
